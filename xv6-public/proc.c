...
write_font(unsigned char *buf, unsigned font_height)
{
  ...
  /* save registers set_plane() modifies GC 4 and
  SEQ 2, so save them as well */
...
// /* Escribe un espacio de memoria */
// static void
// vmemwr(unsigned dst_off, unsigned char *src, unsigned count)
// {
